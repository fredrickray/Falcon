      ...
      {!isFetching && store && (
        <div className="container-fluid">
          <div className="flex flex-col lg:flex-row mx-auto container-fluid items-start p-[10px]">
                      ...
                      <div className="flex flex-wrap mt-4 items-center">
                        ...
                        {showInputField && (
                          ...
                          >
                            ...
                            <div className='flex flex-row border-red-500 border-solid border-8 focus-within:border-green-500'>
                              <ul className='flex gap-x-20'>
                                ...
                                <input className='outline' style={{ flexBasis: "100%" }} type="text" name="" value={inputText} onChange={e => setInputText(e.target.value)} onKeyDown={handleKeydown}/>
            ...
            <div
              className="flex flex-col flex-wrap shadow-md bg-gray-700 ml-4 mb-4"
              style={{
            ...
            >
              ...
              {/* {selectedImages.map((imageUrl, index) => (
                <div className="single-pro-image" key={index}>
                  <img src={imageUrl} width="100%" id="MainImg" alt="" />
