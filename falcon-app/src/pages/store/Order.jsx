...
const Orders = () => {
  ...
  //   if (myDiv.classList.contains("scale-0")) {
  //     myDiv.classList.remove("scale-0");
  //     myDiv.classList.add("scale-100");
  //   } else {
  //     myDiv.classList.remove("scale-100");
  //     myDiv.classList.add("scale-0");
  //   }
  // }

  return (
    <div class="sm-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
      {/* <!-- sidenav  --> */}
      <AsideBar />
      {/* <!-- end sidenav --> */}
...

{
  /* <div class="card-header text-center border-0 pt-0 pt-lg-2 pb-4 pb-lg-3">
            <div class="flex justify-between">
              <a
                href="javascript"
                class="btn btn-sm btn-info mb-0 hidden lg:block"
              >
                Edit
              </a>
              <a
                href="javascript"
                class="btn btn-sm btn-info mb-0 block lg:hidden"
              >
                <i class="ni ni-collection" />
              </a>
              <a
                href="javascript"
                class="btn btn-sm btn-dark float-right mb-0 hidden lg:block"
              >
                Delete
              </a>
              <a
                href="javascript"
                class="btn btn-sm btn-dark float-right mb-0 block lg:hidden"
              >
