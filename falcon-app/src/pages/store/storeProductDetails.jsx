          ...
          <div>
                ...
                <div data-v-7d194230 className='summary_cart'>
                  ...
                  {addedItem && (
                    <div data-v-7d194230 className='summary_cart_item'>
                      {Array.isArray(addedItem) ? (addedItem.map((item) =>
            ...
            <ul id="navbar2">
              ...
              <div data-v-7d194230 className='summary__footer'>
                ...
                <div data-v-7d194230 className='summary__footer__item'>
                  <button type="" className='btn btn--primary btn--block'>Continue to shipping</button>
                </div>
              </div>
            ...
            <div className="single-pro-details">
              ...
              <div className='product_quantity'>
                <div className='action'>
                  <button data-v-7be1d382 type="" className='action__btn action__minus'>
                    <span data-v-7be1d382 className='action__btn_label'>-</span>
                  </button>
                  <input data-v-7be1d382 type="" name="" value="1" className='action__value' />
                  <button data-v-7be1d382 type="" className='action__btn action__plus'>
              ...
              <div className='select_option'>
                ...
                <select>
                  {/* <option className='select_option_name'>Select Size</option> */}
                  <option className='select_option_value'>{result.size}</option>
                </select>
              </div>
