        ...
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li onClick={handleClick} className="mt-0.5 w-full">
            <Link className="py-2.7 shadow-soft-2xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors cursor-pointer">
              ...
              {/* <i section-close-icon="false" class="absolute right-0 pt-1 mr-4 leading-tight fa fa-minus text-xs"></i> */}
            </Link>
          </li>
          ...
          {show &&
            ...
            >
              <a
                class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                href
              >
                <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                  <GiClothes size="500%" style={{height: '100%'}} />
          ...
          <li class="w-full mt-4" style={{marginTop: '25%'}}>
            <a href>
